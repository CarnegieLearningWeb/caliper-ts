...
export function createIlpActivatedEvent(
	params: IlpActivatedEventParams,
	edApp?: SoftwareApplication
): IlpActivatedEvent {
	return {
		'@context': [
			'http://edgenuity.com/events/ilp-activated/0-0-1',
...
export const IlpActivatedEventSchema = {
	context: 'http://edgenuity.com/events/ilp-activated/0-0-1',
	schema: {
		title: 'IlpActivatedEvent',
		type: 'object',
		required: ['@context', 'action', 'object', 'type', 'actor', 'id', 'eventTime', 'edApp'],
		properties: {
			'@context': {
				type: 'array',
				items: [
					{
						type: 'string',
						default: 'http://edgenuity.com/events/ilp-activated/0-0-1',
						enum: ['http://edgenuity.com/events/ilp-activated/0-0-1'],
					},
					{
						type: 'string',
