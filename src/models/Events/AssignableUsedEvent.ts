...
export interface AssignableUsedEvent extends AssignableEvent {
	actor: Student;
...
export interface AssignableUsedEventParams {
	actor: Student;
	object: AssignableDigitalResource | Assessment | AssessmentItem | Lesson;
	generated: Attempt;
	session?: Session | UserSession;
...
export function createAssignableUsedEvent(
	params: AssignableUsedEventParams,
	edApp?: SoftwareApplication
): AssignableUsedEvent {
	return {
		'@context': [
			'http://edgenuity.com/events/assignable-used/0-0-1',
...
export const AssignableUsedEventSchema = {
	context: 'http://edgenuity.com/events/assignable-used/0-0-1',
	schema: {
		title: 'AssignableUsedEvent',
		type: 'object',
		...
		properties: {
			'@context': {
				...
				items: [
					{
						type: 'string',
						default: 'http://edgenuity.com/events/assignable-used/0-0-1',
						enum: ['http://edgenuity.com/events/assignable-used/0-0-1'],
					},
					{
						type: 'string',
