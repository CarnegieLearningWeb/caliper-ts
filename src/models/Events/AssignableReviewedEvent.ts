...
export interface AssignableReviewedEventParams {
	actor: Person | Instructor | User;
	object: AssignableDigitalResource | Assessment | AssessmentItem | Lesson;
	generated: Attempt;
	session?: Session | UserSession;
...
export function createAssignableReviewedEvent(
	params: AssignableReviewedEventParams,
	edApp?: SoftwareApplication
): AssignableReviewedEvent {
	return {
		'@context': [
			'http://edgenuity.com/events/assignable-reviewed/0-0-1',
			'http://purl.imsglobal.org/ctx/caliper/v1p2',
		],
		action: CaliperAction.Reviewed,
...
export const AssignableReviewedEventSchema = {
	context: 'http://edgenuity.com/events/assignable-reviewed/0-0-1',
	schema: {
		title: 'AssignableReviewedEvent',
		type: 'object',
		...
		properties: {
			'@context': {
				...
				items: [
					{
						type: 'string',
						default: 'http://edgenuity.com/events/assignable-reviewed/0-0-1',
						enum: ['http://edgenuity.com/events/assignable-reviewed/0-0-1'],
					},
					{
						type: 'string',
