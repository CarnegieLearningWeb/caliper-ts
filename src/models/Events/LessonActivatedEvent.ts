...
export interface LessonActivatedEvent extends LessonEvent {
	actor: SoftwareApplication | User | Instructor;
	object: LessonEventLesson;
	session?: Session | UserSession;
}

export interface LessonActivatedEventParams {
	actor: SoftwareApplication | User | Instructor;
	object: LessonEventLesson;
	session?: Session | UserSession;
...
export function createLessonActivatedEvent(
	params: LessonActivatedEventParams,
	edApp?: SoftwareApplication
): LessonActivatedEvent {
	return {
		'@context': [
			'http://edgenuity.com/events/lesson-activated/0-0-2',
...
export const LessonActivatedEventSchema = {
	context: 'http://edgenuity.com/events/lesson-activated/0-0-2',
	schema: {
		title: 'LessonActivatedEvent',
		type: 'object',
		...
		properties: {
			'@context': {
				...
				items: [
					{
						type: 'string',
						default: 'http://edgenuity.com/events/lesson-activated/0-0-2',
						enum: ['http://edgenuity.com/events/lesson-activated/0-0-2'],
					},
					{
						type: 'string',
