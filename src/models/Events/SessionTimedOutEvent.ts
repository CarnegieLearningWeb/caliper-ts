...
export interface SessionTimedOutEvent extends SessionEvent {
	actor: SoftwareApplication;
	object: SessionTimedOutEventUserSession;
	target?: DigitalResource;
	referrer?: DigitalResource | SoftwareApplication;
	session?: Session | UserSession;
}

export interface SessionTimedOutEventParams {
	actor: SoftwareApplication;
	object: SessionTimedOutEventUserSession;
	target?: DigitalResource;
	referrer?: DigitalResource | SoftwareApplication;
...
export function createSessionTimedOutEvent(
	params: SessionTimedOutEventParams,
	edApp?: SoftwareApplication
): SessionTimedOutEvent {
	return {
		'@context': [
			'http://edgenuity.com/events/session-timedout/0-0-1',
			'http://purl.imsglobal.org/ctx/caliper/v1p2',
		],
		action: CaliperAction.TimedOut,
...
export interface SessionTimedOutEventUserSession extends UserSession {
	id: string;
	user: User | Instructor | Student;
	client?: SoftwareApplication;
}

export interface SessionTimedOutEventUserSessionParams {
	id: string;
	user: User | Instructor | Student;
	client?: SoftwareApplication;
...
export function createSessionTimedOutEventUserSession(
	params: SessionTimedOutEventUserSessionParams
): SessionTimedOutEventUserSession {
	return {
...
export const SessionTimedOutEventSchema = {
	context: 'http://edgenuity.com/events/session-timedout/0-0-1',
	schema: {
		title: 'SessionTimedOutEvent',
		type: 'object',
		...
		properties: {
			'@context': {
				...
				items: [
					{
						type: 'string',
						default: 'http://edgenuity.com/events/session-timedout/0-0-1',
						enum: ['http://edgenuity.com/events/session-timedout/0-0-1'],
					},
					{
						type: 'string',
