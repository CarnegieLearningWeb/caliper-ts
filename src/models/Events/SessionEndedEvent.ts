...
export interface SessionEndedEvent extends SessionEvent {
	...
	object: SessionEndedEventUserSession;
	target?: DigitalResource;
	referrer?: DigitalResource | SoftwareApplication;
	session?: Session | UserSession;
}

export interface SessionEndedEventParams {
	actor: User | Instructor | Student;
	object: SessionEndedEventUserSession;
	target?: DigitalResource;
	referrer?: DigitalResource | SoftwareApplication;
...
export function createSessionEndedEvent(
	params: SessionEndedEventParams,
	edApp?: SoftwareApplication
): SessionEndedEvent {
	return {
		'@context': [
			'http://edgenuity.com/events/session-ended/0-0-1',
			'http://purl.imsglobal.org/ctx/caliper/v1p2',
		],
		action: CaliperAction.Ended,
...
export interface SessionEndedEventUserSession extends UserSession {
	id: string;
...
export interface SessionEndedEventUserSessionParams {
	id: string;
	user: User | Instructor | Student;
	description: string;
	client?: SoftwareApplication;
...
export function createSessionEndedEventUserSession(
	params: SessionEndedEventUserSessionParams
): SessionEndedEventUserSession {
	return {
...
export const SessionEndedEventSchema = {
	context: 'http://edgenuity.com/events/session-ended/0-0-1',
	schema: {
		...
		properties: {
			'@context': {
				...
				items: [
					{
						type: 'string',
						default: 'http://edgenuity.com/events/session-ended/0-0-1',
						enum: ['http://edgenuity.com/events/session-ended/0-0-1'],
					},
					{
						type: 'string',
			...
			object: {
				...
				allOf: [
					{
						required: ['description', 'user', 'type', 'id'],
					},
					{
						title: 'UserSession',
