...
export interface PlacementActivatedEvent extends Event {
	actor: Instructor | User;
	object: PlacementActivatedEventPlacement;
	session?: Session | UserSession;
}

export interface PlacementActivatedEventParams {
	actor: Instructor | User;
	object: PlacementActivatedEventPlacement;
	session?: Session | UserSession;
	profile?: ProfileType;
...
export function createPlacementActivatedEvent(
	params: PlacementActivatedEventParams,
	edApp?: SoftwareApplication
): PlacementActivatedEvent {
	return {
		'@context': [
			'http://edgenuity.com/events/placement-activated/0-0-1',
...
export interface PlacementActivatedEventPlacement extends Placement {
	id: string;
	assignee: PlacementActivatedEventStudent;
	subject: string;
}

export interface PlacementActivatedEventPlacementParams {
	id: string;
	assignee: PlacementActivatedEventStudent;
	subject: string;
	name?: string;
...
export function createPlacementActivatedEventPlacement(
	params: PlacementActivatedEventPlacementParams
): PlacementActivatedEventPlacement {
	return {
...
export interface PlacementActivatedEventStudent extends Student {
	id: string;
	gradeLevel: number;
	state?: string;
}

export interface PlacementActivatedEventStudentParams {
	id: string;
	gradeLevel: number;
	state?: string;
...
export function createPlacementActivatedEventStudent(
	params: PlacementActivatedEventStudentParams
): PlacementActivatedEventStudent {
	return {
...
export const PlacementActivatedEventSchema = {
	context: 'http://edgenuity.com/events/placement-activated/0-0-1',
	schema: {
		title: 'PlacementActivatedEvent',
		type: 'object',
		...
		properties: {
			'@context': {
				...
				items: [
					{
						type: 'string',
						default: 'http://edgenuity.com/events/placement-activated/0-0-1',
						enum: ['http://edgenuity.com/events/placement-activated/0-0-1'],
					},
					{
						type: 'string',
