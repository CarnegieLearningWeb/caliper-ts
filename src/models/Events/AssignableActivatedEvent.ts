...
export interface AssignableActivatedEvent extends AssignableEvent {
...
export interface AssignableActivatedEventParams {
	actor: Person | Instructor | User;
	object: AssignableDigitalResource | Assessment | AssessmentItem | Lesson;
	generated?: Attempt;
	session?: Session | UserSession;
...
export function createAssignableActivatedEvent(
	params: AssignableActivatedEventParams,
	edApp?: SoftwareApplication
): AssignableActivatedEvent {
	return {
		'@context': [
			'http://edgenuity.com/events/assignable-activated/0-0-1',
...
export const AssignableActivatedEventSchema = {
	context: 'http://edgenuity.com/events/assignable-activated/0-0-1',
	schema: {
		title: 'AssignableActivatedEvent',
		type: 'object',
		...
		properties: {
			'@context': {
				...
				items: [
					{
						type: 'string',
						default: 'http://edgenuity.com/events/assignable-activated/0-0-1',
						enum: ['http://edgenuity.com/events/assignable-activated/0-0-1'],
					},
					{
						type: 'string',
