...
export interface OrganizationActivatedEvent extends Event {
	actor: SoftwareApplication | User | Instructor;
	object: Organization | School | District;
}

export interface OrganizationActivatedEventParams {
	actor: SoftwareApplication | User | Instructor;
	object: Organization | School | District;
...
export function createOrganizationActivatedEvent(
	params: OrganizationActivatedEventParams,
