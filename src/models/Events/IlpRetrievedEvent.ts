...
export const IlpRetrievedEventSchema = {
	context: 'http://edgenuity.com/events/ilp-retrieved/0-0-3',
	schema: {
		...
		properties: {
			'@context': {
				...
				items: [
					{
						type: 'string',
						default: 'http://edgenuity.com/events/ilp-retrieved/0-0-3',
						enum: ['http://edgenuity.com/events/ilp-retrieved/0-0-3'],
					},
					{
						type: 'string',
