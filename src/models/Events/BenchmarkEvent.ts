...
export interface BenchmarkEventParams {
	actor: SoftwareApplication;
	object: BenchmarkEventAttempt;
	generated: BenchmarkEventScore;
	session?: Session | UserSession;
...
export function createBenchmarkEvent(
	params: BenchmarkEventParams,
...
export function createBenchmarkEventAttempt(
	params: BenchmarkEventAttemptParams
...
export function createBenchmarkEventStudent(
	params: BenchmarkEventStudentParams
...
export function createBenchmarkEventScore(params: BenchmarkEventScoreParams): BenchmarkEventScore {
	return {
...
export const BenchmarkEventSchema = {
