...
export interface IlpDeactivatedEventParams {
	actor: Agent | SoftwareApplication | User | Instructor | Student;
	object: IndividualizedLearningPath;
	session?: Session | UserSession;
...
export function createIlpDeactivatedEvent(
	params: IlpDeactivatedEventParams,
...
export const IlpDeactivatedEventSchema = {
	context: 'http://edgenuity.com/events/ilp-deactivated/0-0-2',
	schema: {
		title: 'IlpDeactivatedEvent',
		type: 'object',
		...
		properties: {
			'@context': {
				...
				items: [
					{
						type: 'string',
						default: 'http://edgenuity.com/events/ilp-deactivated/0-0-2',
						enum: ['http://edgenuity.com/events/ilp-deactivated/0-0-2'],
					},
					{
						type: 'string',
