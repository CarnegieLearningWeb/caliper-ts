import { createOrganization, createOrganizationDeactivatedEvent, createUser } from '..';
import Caliper from '../../caliper';
import { validate } from '../../validate';

describe('OrganizationDeactivatedEvent', () => {
	beforeAll(() => {
	...
	it('OK', () => {
		const model = createOrganizationDeactivatedEvent({
