...
export interface AssignableSubmittedEvent extends AssignableEvent {
	actor: Student;
...
export interface AssignableSubmittedEventParams {
	actor: Student;
	object: AssignableDigitalResource | Assessment | AssessmentItem | Lesson;
	generated: Attempt;
	session?: Session | UserSession;
...
export function createAssignableSubmittedEvent(
	params: AssignableSubmittedEventParams,
	edApp?: SoftwareApplication
): AssignableSubmittedEvent {
	return {
		'@context': [
			'http://edgenuity.com/events/assignable-submitted/0-0-1',
			'http://purl.imsglobal.org/ctx/caliper/v1p2',
		],
		action: CaliperAction.Submitted,
...
export const AssignableSubmittedEventSchema = {
	context: 'http://edgenuity.com/events/assignable-submitted/0-0-1',
	schema: {
		title: 'AssignableSubmittedEvent',
		type: 'object',
		...
		properties: {
			'@context': {
				...
				items: [
					{
						type: 'string',
						default: 'http://edgenuity.com/events/assignable-submitted/0-0-1',
						enum: ['http://edgenuity.com/events/assignable-submitted/0-0-1'],
					},
					{
						type: 'string',
