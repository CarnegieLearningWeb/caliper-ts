...
export const OrganizationCreatedEventSchema = {
	context: 'http://edgenuity.com/events/organization-created/0-0-6',
	schema: {
		...
		properties: {
			'@context': {
				...
				items: [
					{
						type: 'string',
						default: 'http://edgenuity.com/events/organization-created/0-0-6',
						enum: ['http://edgenuity.com/events/organization-created/0-0-6'],
					},
					{
						type: 'string',
