...
export function createGroupUpdatedEvent(
	...
	return {
		'@context': [
			'http://edgenuity.com/events/group-updated/0-0-3',
...
export const GroupUpdatedEventSchema = {
	context: 'http://edgenuity.com/events/group-updated/0-0-3',
	schema: {
		...
		properties: {
			'@context': {
				...
				items: [
					{
						type: 'string',
						default: 'http://edgenuity.com/events/group-updated/0-0-3',
						enum: ['http://edgenuity.com/events/group-updated/0-0-3'],
					},
					{
						type: 'string',
