...
export interface AssignableDeactivatedEvent extends AssignableEvent {
...
export interface AssignableDeactivatedEventParams {
	actor: Person | Instructor | User;
	object: AssignableDigitalResource | Assessment | AssessmentItem | Lesson;
	generated?: Attempt;
	session?: Session | UserSession;
...
export function createAssignableDeactivatedEvent(
	params: AssignableDeactivatedEventParams,
	edApp?: SoftwareApplication
): AssignableDeactivatedEvent {
	return {
		'@context': [
			'http://edgenuity.com/events/assignable-deactivated/0-0-1',
...
export const AssignableDeactivatedEventSchema = {
	context: 'http://edgenuity.com/events/assignable-deactivated/0-0-1',
	schema: {
		title: 'AssignableDeactivatedEvent',
		type: 'object',
		...
		properties: {
			'@context': {
				...
				items: [
					{
						type: 'string',
						default: 'http://edgenuity.com/events/assignable-deactivated/0-0-1',
						enum: ['http://edgenuity.com/events/assignable-deactivated/0-0-1'],
					},
					{
						type: 'string',
