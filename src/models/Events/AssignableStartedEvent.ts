...
export interface AssignableStartedEvent extends AssignableEvent {
	actor: Student;
...
export interface AssignableStartedEventParams {
	actor: Student;
	object: AssignableDigitalResource | Assessment | AssessmentItem | Lesson;
	generated: Attempt;
	session?: Session | UserSession;
...
export function createAssignableStartedEvent(
	params: AssignableStartedEventParams,
	edApp?: SoftwareApplication
): AssignableStartedEvent {
	return {
		'@context': [
			'http://edgenuity.com/events/assignable-started/0-0-1',
...
export const AssignableStartedEventSchema = {
	context: 'http://edgenuity.com/events/assignable-started/0-0-1',
	schema: {
		title: 'AssignableStartedEvent',
		type: 'object',
		...
		properties: {
			'@context': {
				...
				items: [
					{
						type: 'string',
						default: 'http://edgenuity.com/events/assignable-started/0-0-1',
						enum: ['http://edgenuity.com/events/assignable-started/0-0-1'],
					},
					{
						type: 'string',
